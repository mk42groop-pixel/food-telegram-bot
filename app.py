...
class YandexGPTGenerator:
        ...
        try:
            ...
            data = {
                ...
                "messages": [
                    {
                        "role": "system",
                        "text": "Ты - профессиональный нутрициолог и шеф-повар. Создавай полезные, вкусные и простые рецепты для семьи."
                    },
                    {
                        "role": "user", 
                        "text": prompt
    ...
    def _build_prompt(self, recipe_type, theme):
        ...
        prompts = {
            'breakfast': f"Создай рецепт полезного семейного завтрака на тему '{theme}'. Включи ингредиенты на 4 человек и пошаговое приготовление.",
            'lunch': f"Создай рецепт питательного семейного обеда на тему '{theme}'. Включи ингредиенты на 4 человек и пошаговое приготовление.", 
            'dinner': f"Создай рецепт легкого семейного ужина на тему '{theme}'. Включи ингредиенты на 4 человек и пошаговое приготовление.",
            'dessert': f"Создай рецепт полезного десерта для семьи на тему '{theme}'. Включи ингредиенты на 4 человек и пошаговое приготовление.",
            'advice': f"Дай полезный совет нутрициолога на тему '{theme}' для семьи с детьми."
        }
...
{benefits}"""
        ...
        # Добавляем унифицированную концовку
...
🍴 <b>Приятного аппетита!</b>"""
    ...
    def generate_protein_breakfast(self):
        ...
        nutrition_facts = """• 🔥 Калории: 280 ккал
• 🍗 Белки: 30 г
• 🥑 Жиры: 12 г  
• 🌾 Углеводы: 15 г"""
        
        ingredients = """• 🧀 Творог 5% - 600 г
• 🥚 Яйца - 3 шт
• 🌾 Манка - 3 ст.л.
• 🍯 Мед - 3 ст.л.
• 🍎 Яблоки - 2 шт
...
• 🌿 Ванилин"""
        ...
        cooking_steps = """1. 🧀 Творог протереть через сито
2. ➕ Добавить яйца, мед, манку, ванилин
3. 🍎 Яблоки нарезать кубиками
4. 🍯 Форму смазать маслом, выложить тесто
5. 🫘 Посыпать корицей и яблоками
6. 🔥 Запекать 25 минут при 180°C"""
        ...
        benefits = """• 💪 Строительный материал для мышц
