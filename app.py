    ...
    def __init__(self):
        self.kemerovo_schedule = {
            ...
            0: {
                ...
                "13:00": {"name": "🍲 Обед для концентрации", "type": "focus_lunch", "method": "generate_neuro_breakfast"}, 
                "17:00": {"name": "💡 Совет нутрициолога", "type": "advice", "method": "generate_neuro_breakfast"},
                "19:00": {"name": "🥗 Ужин для мозга", "type": "brain_dinner", "method": "generate_neuro_breakfast"}
            },
            ...
            1: {
                ...
                "13:00": {"name": "🍵 Чечевичный суп с индейкой", "type": "protein_lunch", "method": "generate_protein_breakfast"},
                "17:00": {"name": "💡 Совет по белкам", "type": "advice", "method": "generate_protein_breakfast"},
                "19:00": {"name": "🍗 Куриные грудки с киноа", "type": "protein_dinner", "method": "generate_protein_breakfast"}
            },
            # СРЕДА - 🥬 "ОВОЩНОЙ ДЕНЬ"
            2: {
                "08:00": {"name": "🥤 Смузи-боул с семенами чиа", "type": "veggie_breakfast", "method": "generate_carbs_breakfast"},
                "13:00": {"name": "🥬 Овощное рагу с фасолью", "type": "veggie_lunch", "method": "generate_veggie_lunch"},
                "17:00": {"name": "💡 Польза клетчатки", "type": "advice", "method": "generate_veggie_lunch"},
                "19:00": {"name": "🥑 Салат с авокадо и нутом", "type": "veggie_dinner", "method": "generate_veggie_lunch"}
            },
            # ЧЕТВЕРГ - 🍠 "СЛОЖНЫЕ УГЛЕВОДЫ"
            3: {
                "08:00": {"name": "🍠 Энергетическая овсянка с чиа", "type": "carbs_breakfast", "method": "generate_carbs_breakfast"},
                "13:00": {"name": "🍚 Бурый рис с курицей", "type": "carbs_lunch", "method": "generate_carbs_breakfast"},
                "17:00": {"name": "💡 Энергия углеводов", "type": "advice", "method": "generate_carbs_breakfast"},
                "19:00": {"name": "🥔 Запеченный картофель", "type": "carbs_dinner", "method": "generate_carbs_breakfast"}
            },
            # ПЯТНИЦА - 🎉 "ВКУСНО И ПОЛЕЗНО"
            4: {
                "08:00": {"name": "🥞 Блинчики цельнозерновые", "type": "carbs_breakfast", "method": "generate_carbs_breakfast"},
                "13:00": {"name": "🍝 Паста с фасолью", "type": "carbs_lunch", "method": "generate_veggie_lunch"},
            ...
            5: {
                "10:00": {"name": "🍳 Семейный завтрак", "type": "family_breakfast", "method": "generate_neuro_breakfast"},
                ...
                "19:00": {"name": "🍽️ Семейный ужин", "type": "family_dinner", "method": "generate_protein_breakfast"}
            },
            ...
            6: {
                ...
                "17:00": {"name": "🍮 Воскресный десерт", "type": "sunday_dessert", "method": "generate_friday_dessert"},
                "19:00": {"name": "📋 Настрой на неделю", "type": "week_prep_dinner", "method": "generate_protein_breakfast"}
            }
        }
...
if __name__ == '__main__':
    ...
    print("📊 Контент-план: 28 постов в неделю")
