...
👨‍🍳 <b>ПРОЦЕСС ПРИГОТОВЛЕНИЯ:</b>
<tg-spoiler>1. 🧀 Творог протереть через сито
...
6. 🔥 Запекать 25 минут при 180°C</tg-spoiler>
...
👨‍🍳 <b>ПРОЦЕСС ПРИГОТОВЛЕНИЯ:</b>
<tg-spoiler>{cooking_steps}</tg-spoiler>
...
<tg-spoiler><b>1. 📝 ПЛАНИРОВАНИЕ (20 минут в воскресенье)</b>
...
• Наслаждайся готовой едой без стресса</tg-spoiler>
