        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <p>Клуб Осознанного Питания - 38 постов в неделю с научным подходом</p>
...
if __name__ == '__main__':
    ...
    print("🎯 Контент-план: 38 постов в неделю")
    ...
    print("🔒 Скрытые описания приготовления: исправлены")
