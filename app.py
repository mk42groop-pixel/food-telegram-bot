...
class RecipeDiversityManager:
    def __init__(self):
        ...
        self.vegetable_rotation = [
            ...
            "лук репчатый", "лук зеленый", "чеснок", "редис", "редис дайкон",
            "кабачки", "баклажаны", "перец болгарский", "тыква", "редис",
...
class EnhancedYandexGPTGenerator:
    ...
    def generate_content(self, content_type, theme):
        ...
        logger.warning("⚠️ Используем шаблонный контент")
    ...
    def _create_cache_key(self, content_type, theme):
        ...
        return f"{content_type}_{normalized_theme}_{hash(normalized_theme)}"
...
4. Используй только распространенные в России продукты
5. Исключи тхину, пастернак, ревень, топинамбур, кольраби, мангольд
6. Исключи копчение, гриль, мангал"""
...
ОБЯЗАТЕЛЬНЫЕ ТРЕБОВАНИЯ:
1. Используй эмодзи в каждом сообщении для визуальной привлекательности
2. Соблюдай принцип постепенной прогрессии нагрузок
3. Включай научное обоснование эффективности упражнений
4. Предоставляй альтернативы для разных уровней подготовки
5. Акцент на правильную технику выполнения"""
...
ОБЯЗАТЕЛЬНЫЕ ТРЕБОВАНИЯ:
1. Используй эмодзи для визуальной привлекательности
2. Основывайся на доказательной медицине
3. Предоставляй практические рекомендации
4. Учитывай российские пищевые традиции
5. Избегай медицинских назначений и рекомендаций по БАДам"""
...
2. 📊 ПИЩЕВАЯ ЦЕННОСТЬ НА ПОРЦИЮ
3. 🛒 ИНГРЕДИЕНТЫ НА 4 ПОРЦИИ
4. 👨‍🍳 ПРОЦЕСС ПРИГОТОВЛЕНИЯ
5. 💡 НАУЧНОЕ ОБОСНОВАНИЕ ПОЛЬЗЫ

Создай по-настоящему уникальный рецепт из доступных российских продуктов!"""
...
1. 🎯 ЗАГОЛОВОК С ЭМОДЗИ
2. ⏱️ ПРОДОЛЖИТЕЛЬНОСТЬ И УРОВЕНЬ СЛОЖНОСТИ
3. 🏋️‍♂️ РАЗМИНКА (5-10 минут)
4. 💪 ОСНОВНАЯ ЧАСТЬ (упражнения с подходами/повторениями)
5. 🧘‍♂️ ЗАМИНКА И РАСТЯЖКА
6. 💡 НАУЧНОЕ ОБОСНОВАНИЕ ЭФФЕКТИВНОСТИ

Создай эффективную и безопасную программу тренировок!"""
    ...
    def _build_nutrition_advice_prompt(self, advice_type, theme):
        ...
        focus = advice_focus.get(advice_type, "общие принципы здорового питания")
...
📝 СТРУКТУРА СОВЕТА:
1. 🎯 ЗАГОЛОВОК С ЭМОДЗИ
2. 🔬 НАУЧНАЯ ОСНОВА (с объяснением физиологических процессов)
3. 💡 ПРАКТИЧЕСКИЕ РЕКОМЕНДАЦИИ
4. ⚠️ РАСПРОСТРАНЕННЫЕ ОШИБКИ
5. 📊 ИЗМЕРИМЫЕ РЕЗУЛЬТАТЫ
6. 🗓️ ПЛАН ВНЕДРЕНИЯ В ЖИЗНЬ
...
Создай профессиональный, научно обоснованный совет от нутрициолога!"""
    ...
    def _get_nutrition_template(self, content_type, theme):
        """Шаблон для советов нутрициолога"""
        templates = {
            'monday_science': """🧠 <b>НЕЙРОПИТАНИЕ ДЛЯ СТАРТА НЕДЕЛИ</b>

🔬 <b>НАУЧНАЯ ОСНОВА:</b>
Понедельник - пик выработки кортизола и норадреналина, требующий усиленной нейроподдержки для запуска когнитивных процессов после выходных.
...
🔬 <b>НАУЧНАЯ ОСНОВА:</b>
Вторник - активация mTOR пути после понедельничных нагрузок, оптимальное время для синтеза мышечного белка и восстановления.
...
🔬 <b>НАУЧНАЯ ОСНОВА:</b>
Среда - пик токсической нагрузки, активация систем детоксикации печени и поддержка микробиома кишечника.
...
🔬 <b>НАУЧНАЯ ОСНОВА:</b>
Четверг - истощение гликогеновых запасов, оптимизация митохондриальной функции для поддержания энергии.
...
🔬 <b>НАУЧНАЯ ОСНОВА:</b>
Пятница - баланс между дофаминовой системой вознаграждения и поддержанием дисциплины питания.
...
🔬 <b>НАУЧНАЯ ОСНОВА:</b>
Суббота - повышение окситоцина при совместных трапезах, формирование пищевых привычек у детей.
...
🔬 <b>НАУЧНАЯ ОСНОВА:</b>
Воскресенье - снижение decision fatigue при планировании, оптимизация когнитивных ресурсов на неделю.
...
🎯 <b>РЕЗУЛЬТАТ:</b> Экономия 5+ часов в неделю, снижение стресса на 60%"""
    ...
    def _get_training_template(self, content_type, theme):
        """Шаблон для тренировок"""
        return f"""💪 <b>{theme.upper()}</b>

🏋️‍♂️ <b>ПРОГРАММА ТРЕНИРОВКИ:</b>
• ⏱️ Продолжительность: 30-45 минут
• 🎯 Уровень: начальный/средний
• 🏠 Оборудование: минимальное

🔥 <b>РАЗМИНКА (5-10 минут):</b>
• Ходьба на месте
• Вращения суставами
• Динамическая растяжка

💪 <b>ОСНОВНАЯ ЧАСТЬ:</b>
• Упражнение 1: 3 подхода по 10-15 повторений
• Упражнение 2: 3 подхода по 10-15 повторений  
• Упражнение 3: 3 подхода по 10-15 повторений
...
Регулярные тренировки улучшают метаболизм, укрепляют сердечно-сосудистую систему и повышают качество жизни."""
